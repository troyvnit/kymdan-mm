    ...
    public class ViewModelToDomainMappingProfile : Profile
    {
        ...
        protected override void Configure()
        {
            Mapper.CreateMap<MaterialProposalViewModel, MaterialProposal>()
                .ForMember(a => a.ProposalCode, o => o.MapFrom(a => a.ProposalCode.Replace("_", "").ToUpper()))
    ...
    public class DomainToViewModelMappingProfile : Profile
    {
        ...
        protected override void Configure()
        {
            Mapper.CreateMap<MaterialProposal, MaterialProposalViewModel>().ForMember(a => a.Approved, o => o.MapFrom(a => a.Materials.Count(m => !m.Approved) == 0))
                .ForMember(a => a.MinDeadline, o => o.MapFrom(a => a.Materials.Min(m => m.Deadline) != null ? ((DateTime)a.Materials.Min(m => m.Deadline)).Date : DateTime.MinValue.Date))
